...
\textcolor{red}{The field-specific leadership claims for Wageningen (Agricultural \& Biological Sciences, Environmental Science) and Carnegie Mellon (Computer Science) are noisier with five trials per rate: each survives in 3 to 5 of 5 trials at every rate tested. Carnegie Mellon's Computer Science lead is the most robust, failing in only one trial across the entire grid; Wageningen's two leads are each knocked out in one trial at some rate, without a clear ordering between them. Italy and Japan's near-parity in h\textsubscript{3} despite a 6$\times$ difference in institutional scale is preserved throughout the tested range: both values rise together under added noise (Italy 45 at $p=1\%$ to 66--67 at $p=80\%$; Japan 46 to 86--88 over the same range), and while their ratio drifts from about 0.96 down to about 0.76 as $p$ increases, even at that extreme it remains more than four times tighter than the underlying 1:6 gap in institutional count.}
...
\begin{table}[h]
	...
	\textcolor{red}{13\%*} & \textcolor{red}{0.991} & \textcolor{red}{83\%} & \textcolor{red}{0.997}  & \textcolor{red}{90\%}  & \textcolor{red}{3/5} & \textcolor{red}{5/5} & \textcolor{red}{4/5} \\
